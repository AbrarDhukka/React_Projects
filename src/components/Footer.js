...
const Footer = () => {
  return (
    ...
    <footer
      ...
      <div className="mx-6 py-10 text-center md:text-left bg-sky-700 text-white">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            ...
            <p>
              Here you can order you favourite food. Lorem ipsum dolor sit amet, consectetur adipisicing
              elit.
            </p>
          </div>
          {/* <!-- Products section --> */}
          <div className="text-white">
            ...
            <p className="mb-4">
              <a className=" dark:text-neutral-200 text-white"
              >Pizza</a>
            </p>
            <p className="mb-4">
              <a className="text-white dark:text-neutral-200"
      ...
      {/* <!--Copyright section--> */}
      <div className="bg-sky-700 p-6 text-center text-white dark:bg-neutral-700">
        <span>© 2023 MadeBy:</span>
        <a
