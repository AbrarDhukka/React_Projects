  ...
  return (
    <div id="rest-card-container">
      <div className="m-3 p-[10px] w-[275px] bg-slate-100 drop-shadow-sm h-[370px] leading-5 rounded-[10px] ">
        <img
          className="w-[300px] h-[190px] rounded-xl"
          src={
          ...
          alt="food image"
        ></img>
        <h2 className="font-bold text-lg mt-2 w-[265px] overflow-hidden text-ellipsis whitespace-nowrap">
          {name}
        </h2>
        ...
        <h3 className="w-[260px] overflow-hidden text-ellipsis whitespace-nowrap">
          {cuisines.join(", ")}
        </h3>
...
export const withPromotedLabel = (CardComp) => {
  return (props) => {
    return (
      <div>
        <label className="p-[6px] absolute rounded-xl bg-slate-500 text-white z-10 ">
          Promoted
        </label>
