...
const Contact = () => {
  return (
    <div className="w-[1530px] bg-white">

      <section className="bg-white py-20 lg:py-[120px] overflow-hidden relative z-10 w-[1200px] mx-auto">
        <div className="container">
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="block mb-4 text-base font-semibold text-primary text-blue-950">
                  Contact Us
                </span>
                <h2 className="mb-6 text-[32px] font-bold uppercase text-dark sm:text-[40px] lg:text-[36px] xl:text-[40px] text-blue-950">
                  GET IN TOUCH WITH US
                </h2>
                <p className="text-base leading-relaxed mb-9 text-blue-950 ">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eius tempor incididunt ut labore e dolore magna aliqua. Ut
                  enim adiqua minim veniam quis nostrud exercitation ullamco
                </p>
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px] text-blue-950">
                    <svg
                      width={24}
                      height={24}
                      viewBox="0 0 24 24"
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-xl font-bold text-blue-950">
                      Our Location
                    </h4>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-xl font-bold text-blue-950 text-dark">
                      Phone Number
                    </h4>
                    <p className="text-base text-blue-950">
                      (+62)81 414 257 9980
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-xl font-bold text-dark text-blue-950">
                      Email Address
                    </h4>
                    <p className="text-base text-blue-950">
                      info@yourdomain.com
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative p-8 bg-sky-100 rounded-lg shadow-xl sm:p-12 text-blue-950">
                <form>
                  <ContactInputBox
                    type="text"
                    name="name"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-white bg-sky-700 transition border rounded border-primary bg-primary hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
    ...
    <>
      <div className="mb-6">
        <textarea
          ...
          name={name}
          className="border-blue-300 w-full resize-none rounded border py-3 px-[14px] text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none"
    ...
    <>
      <div className="mb-6">
        <input
          ...
          placeholder={placeholder}
          name={name}
          className="border-blue-300 w-full rounded border py-3 px-[14px] text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none"
        />
      </div>
    </>
  );
